...
def rest_request ( query ,wsUser,wsPass):
    ...
    print json.dumps(results, indent=0, sort_keys=True) 
...
wsUser = 'hack_user02'
wsPass = 'tdhackathon'
perform_query ( 'select * from transportation.monthy_number_of_airline_passengers_all_carriers', wsUser, wsPass)
